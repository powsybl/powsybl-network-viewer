...
import DrawControl, { getMapDrawer } from './draw-control-mapbox';
...
function getMapStyle(mapTheme: LiteralUnion<MapTheme, string>) {
...
export type NetworkMapboxProps = NetworkMapProps & {
    mapBoxToken?: string;
};

const NetworkMap = forwardRef<NetworkMapRef, NetworkMapboxProps>(
    (
        {
            // default props
            areFlowsValid,
