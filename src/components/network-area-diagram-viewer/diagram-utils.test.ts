...
test('getEdgeType', () => {
    ...
    expect(DiagramUtils.getEdgeType(edge)).toBe(EdgeType.TWO_WINDINGS_TRANSFORMER);
...
test('getRightClickableElementData', () => {
    ...
    elementData = DiagramUtils.getRightClickableElementData('16', ElementType.BRANCH, nodes, textNodes, edges);
